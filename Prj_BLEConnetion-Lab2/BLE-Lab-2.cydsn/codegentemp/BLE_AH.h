...
#include "BLE_AH_Stack.h"
#include "BLE_AH_StackHostMain.h"
#include "BLE_AH_StackGap.h"
#include "BLE_AH_StackGattServer.h"
#include "BLE_AH_StackGattClient.h"
#include "BLE_AH_StackGattDb.h"
#include "BLE_AH_StackL2cap.h"
...
/* Tx Power Level */
#define CYBLE_TX_POWER_LEVEL_ADV                    (CYBLE_LL_PWR_LVL_NEG_1_DBM)
#define CYBLE_TX_POWER_LEVEL_CONN                   (CYBLE_LL_PWR_LVL_NEG_1_DBM)
...
#define CYBLE_SCN_PKT_INDEX_TX_POWER_LEVEL   (0x0Eu)
...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x000Cu == 0u) ? (1u) : (0x000Cu))
